...
These routes have all the information needed by a navigation item to build a menu point and define the routing target.</p><p>The following picture shows an high level overview of the architecture.</p><p><img src="images/blog/vue-route-menu/nav-structure.drawio.svg" alt="Planned structure"></p><h2 id="tldr-3">TL;DR</h2>
<p>You can check out the complete working example with the source code in the following Stackblitz project:</p><p><a href="https://stackblitz.com/edit/vue3-dynamic-menu">https://stackblitz.com/edit/vue3-dynamic-menu</a></p><h2 id="basic-app-setup-1">basic app setup</h2>
...
<h2 id="setup-the-router-1">Setup the router</h2>
...
<span class="line"><span style="color:#E1E4E8">&#x3C;/</span><span style="color:#85E89D">template</span><span style="color:#E1E4E8">></span></span></code></pre>
<h2 id="build-the-menu-items-based-on-route-meta-1">Build the menu items based on route <code>meta</code></h2>
...
<h2 id="make-the-navigation-extensible-1">Make the navigation extensible</h2>
...
<span class="line"><span style="color:#E1E4E8">  &#x3C;/</span><span style="color:#85E89D">li</span><span style="color:#E1E4E8">></span></span>
<span class="line"><span style="color:#E1E4E8">&#x3C;/</span><span style="color:#85E89D">template</span><span style="color:#E1E4E8">></span></span></code></pre>
<h2 id="styling-active-links-1">Styling active links</h2>
