...
Die PWA lässt sich wie jede andere App nutzen, inklusive Push-Benachrichtigungen!</p><h2 id="webanwendung-vs-pwa-vs-app-1">Webanwendung vs. PWA vs. App</h2>
...
Eine weitere Aufgabe ist das Empfangen von Push-Benachrichtigungen vom Server.</p><h3 id="eine-bestehende-angular-anwendung-in-eine-pwa-verwandeln-1">Eine bestehende Angular-Anwendung in eine PWA verwandeln</h3>
...
<h2 id="add-to-homescreen-1">Add to Homescreen</h2>
...
Aber: Haben wir hier noch keine speziellen Icons hinterlegt, wird ggf. nur eine Miniatur der Website als Icon angezeigt.</p><h3 id="das-web-app-manifest-anpassen-manifestjson-1">Das Web App Manifest anpassen (<code>manifest.json</code>)</h3>
...
Wollen wir das Standard-Icon ändern, laden wir hier einfach ein Bild hoch und lassen die zugehörigen Bilder erzeugen. Nach dem Entpacken der ZIP-Datei speichern wir die Icons in unserem Projekt unter <code>src/assets/icons</code> ab. Anschließend sollten wir noch einmal die Pfade in der Datei <code>manifest.json</code> prüfen.</p><p><img src="images/blog/web-app-manifest-generator.png" alt="Screenshot Web App Manifest Generator"></p><h3 id="anpassungen-für-ios-indexhtml-1">Anpassungen für iOS (<code>index.html</code>)</h3>
...
<h3 id="auf-die-push-notification-reagieren-1">Auf die Push Notification reagieren</h3>
...
<code>SwPush</code> bietet also keine einfache Möglichkeit, eine Nachricht aus einer lokalen Quelle anzuzeigen.</p><h3 id="ein-blick-unter-die-haube-von-push-notifications-1">Ein Blick unter die Haube von Push Notifications</h3>
...
Bitte behalten Sie diesen Punkt stets im Hinterkopf: Alle Push-Nachrichten werden immer durch einen fremden Server zum Client gebracht.</p><h2 id="zusammenfassung-1">Zusammenfassung</h2>
