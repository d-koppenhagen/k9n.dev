import{ɵ as g,a as f,i as C,t as b,Q as x,N as P,O as j,d as v,l as i,e as l,f as y,o as c,p as s,h as d,j as M,A as w,k,n as _,m,s as u,r as O,q as p,u as h}from"./index-mMuXI6oy.js";import{M as z}from"./meta.service-CowikIAg.js";const B=["shareBtnBox"];function Q(e,o){if(e&1&&m(0,"img",8),e&2){const t=u();p("src",t.attributes.thumbnail.header,h)}}function S(e,o){if(e&1&&(i(0,"h1"),_(1),c(),i(2,"section",2),l(3,Q,1,1,"img",3),c(),i(4,"section",4),m(5,"analog-markdown",5),i(6,"div",6)(7,"a",7),_(8," Auf GitHub bearbeiten "),c()()()),e&2){const t=o,n=u();s(),O(t.attributes.title),s(2),d(3,t.attributes.thumbnail&&t.attributes.thumbnail.header?3:-1),s(2),p("lang",t.attributes.language||"de")("content",t.content),s(2),p("href",n.editOnGithubLink(t.filename),h)}}let F=(()=>{var e;class o{constructor(n){this.metaService=n,this.post$=C({param:"slug",subdirectory:"projects"}).pipe(b(a=>this.metaService.createMetaDataForPost("projects",a)))}editOnGithubLink(n){return`https://github.com/d-koppenhagen/k9n.dev/edit/main${n}`}}return e=o,e.ɵfac=function(n){return new(n||e)(g(z))},e.ɵcmp=f({type:e,selectors:[["ng-component"]],viewQuery:function(n,a){if(n&1&&x(B,5),n&2){let r;P(r=j())&&(a.shareBtnBox=r.first)}},standalone:!0,features:[v],decls:4,vars:3,consts:[[1,"wrapper","alt"],[1,"inner"],[1,"project-header"],["alt",""],[1,"project-content"],["classes","markdown-content",3,"lang","content"],[1,"edit-on-github"],["target","_blank","rel","noopener noreferrer",3,"href"],["alt","",3,"src"]],template:function(n,a){if(n&1&&(i(0,"article",0)(1,"div",1),l(2,S,9,5),y(3,"async"),c()()),n&2){let r;s(2),d(2,(r=M(3,1,a.post$))?2:-1,r)}},dependencies:[w,k],styles:[`.wrapper[_ngcontent-%COMP%] {
  margin-top: 0;
}
