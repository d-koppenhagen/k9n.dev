...
<p>The default Terminal app for macOS fulfills its purpose but for being more productive I can recommend the terminal application <strong><a href="https://iterm2.com">iTerm2</a></strong>.</p>
<p>I am using iTerm2 since a long time and it&#39;s a great tool with lots of configuration options.
You can create tabs, use profiles and customize styles and layouts.</p>
<p><img src="images/blog/dev-setup/iterm2.png" alt="Screenshot: iTerm2"></p>
<h3 id="cakebrew--macos-only"><a href="https://www.cakebrew.com">Cakebrew</a> – macOS only</h3>
...
<p><img src="images/blog/dev-setup/cakebrew.png" alt="Screenshot: CakeBrew"></p>
<h3 id="nvm"><a href="https://github.com/nvm-sh/nvm">NVM</a></h3>
...
<h3 id="fork"><a href="https://git-fork.com">Fork</a></h3>
...
<p><img src="images/blog/dev-setup/fork.png" alt="Screenshot: Fork"></p>
...
<p><img src="images/blog/dev-setup/vscode.png" alt="Screenshot: VSCode"></p>
<p>Later in this article, I will present you a list of my favorite extensions for VSCode.</p>
<h3 id="chrome"><a href="https://google.com/chrome">Chrome</a></h3>
...
<p><img src="images/blog/dev-setup/chrome.png" alt="Screenshot: Google Chrome"></p>
<p>A list of my favorite extensions for Google Chrome can be found further down in this article.</p>
<h3 id="insomnia"><a href="https://insomnia.rest">Insomnia</a></h3>
...
<p><img src="images/blog/dev-setup/insomnia.png" alt="Screenshot: Insomnia"></p>
<h3 id="drawio"><a href="https://draw.io">draw.io</a></h3>
...
<p><img src="images/blog/dev-setup/drawio.png" alt="Screenshot: draw.io"></p>
<h3 id="recordit"><a href="https://recordit.co">RecordIt</a></h3>
...
<p><img src="images/blog/dev-setup/recordit.png" alt="Screenshot: RecordIt"></p>
<h3 id="keycastr"><a href="https://github.com/keycastr/keycastr">KeyCastr</a></h3>
...
<p><img src="images/blog/dev-setup/keycastr.png" alt="Screenshot: KeyCastr"></p>
...
<h3 id="exclude-all-node_modules-from-timemachine-backups-macos-only">Exclude all <code>node_modules</code> from TimeMachine backups (macOS only)</h3>
...
It looks for all <code>node_modules</code> directories in my development directory (<code>~/dev</code> in my case) and excludes them from the backup:</p>
...
<p>To be sure the script updates the list of excluded directories frequently, I added a cronjob:</p>
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#B392F0">crontab</span><span style="color:#79B8FF"> -e</span></span></code></pre>
<p>The actual cronjob config is the following:</p>
...
Then just contact me via <a href="mailto:mail@k9n.dev">E-Mail</a> or <a href="https://bsky.app/profile/k9n.dev">Bluesky</a> and let me know!</p>
