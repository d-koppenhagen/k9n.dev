...
<h1 id="create-powerful-fast-pre-rendered-angular-apps-using-scully-static-site-generator-1">Create powerful fast pre-rendered Angular Apps using <em>Scully</em> static site generator</h1>
...
<h2 id="about-scully-1">About Scully</h2>
...
The power of pre-rendering and very fast access to sites and the power of a fully functional Single Page Application (SPA) written in Angular.</p><h2 id="get-started-1">Get started</h2>
...
This server serves the static generated pages from the <code>dist/static</code> directory like a normal web server (e.g. <em>nginx</em> or <em>apache</em>).</p><h2 id="the-scullylibmodule-1">The <code>ScullyLibModule</code></h2>
...
So in that case even if a page has been fully loaded, <em>Scully</em> would wait until the timer is expired.</p><h2 id="turn-it-into-a-blog-1">Turn it into a blog</h2>
...
We now have two files there: The initially created example file from <em>Scully</em> and this one we created with <code>ng g @scullyio/init:post</code>.</p><h2 id="lets-go-further-1">Let&#39;s go further</h2>
...
<h2 id="use-the-scullyroutesservice-1">Use the <code>ScullyRoutesService</code></h2>
...
Now you just need to add a bit of styling and content and your blog is ready for getting visited.</p><h2 id="fetch-dynamic-information-from-an-api-1">Fetch dynamic information from an API</h2>
...
<a href="https://github.com/d-koppenhagen/scully-blog-example">scully-blog-example</a>.</p><h2 id="conclusion-7">Conclusion</h2>
