...
However, since some of these are already implemented in the Angular CLI, I want to show you some of those typical helpers that you can use for you Angular CLI Schematic project to prevent any pitfalls.</p><h2 id="️-attention-not-officially-supported-1">⚠️ Attention: not officially supported</h2>
...
Clone this repo and check out the <code>README.md</code> inside to get started with the playground. 🚀</p><h2 id="create-an-angular-schematics-example-project-1">Create an Angular schematics example project</h2>
...
<p>The <code>.</code> refers to the current directory where our schematics project lives.</p><p><a href="https://github.com/d-koppenhagen/schematics-helpers-playground/tree/master/playground/src/playground">Check out the basic example in the playground repository on GitHub</a></p><h3 id="basic-types-1">Basic types</h3>
...
<h3 id="install-the-helpers-from-schematicsangular-1">Install the helpers from <code>@schematics/angular</code></h3>
...
<h2 id="changing-the-packagejson-get-add-and-remove-dev--peer--dependencies-1">Changing the <code>package.json</code>: Get, Add and Remove (dev-, peer-) dependencies</h2>
...
<h2 id="add-content-on-a-specific-position-1">Add content on a specific position</h2>
...
<h2 id="determine-relative-path-to-the-project-root-1">Determine relative path to the project root</h2>
...
<h2 id="add-typescript-imports-1">Add TypeScript imports</h2>
...
<h2 id="update-ngmodule-1">Update <code>NgModule</code></h2>
...
These function also based on the <code>insertImport()</code> function, so that they will handle existing file imports and just update the import lists accordingly.</p><h3 id="add-a-declaration-to-a-module-1">Add a declaration to a module</h3>
...
<h3 id="ngmodule-add-imports-exports-providers-and-bootstrap-1"><code>NgModule</code>: add <code>imports</code>, <code>exports</code>, <code>providers</code>, and <code>bootstrap</code></h3>
...
<span class="line"><span style="color:#E1E4E8">})</span></span>
<span class="line"><span style="color:#F97583">export</span><span style="color:#F97583"> class</span><span style="color:#B392F0"> AppModule</span><span style="color:#E1E4E8"> { }</span></span></code></pre>
<h3 id="add-route-declarations-1">Add route declarations</h3>
...
<h2 id="retrieve-the-angular-workspace-configuration-1">Retrieve the Angular workspace configuration</h2>
...
<h2 id="get-default-path-for-an-app-inside-the-workspace-1">Get default path for an app inside the workspace</h2>
...
<h2 id="call-schematics-from-schematics-1">Call schematics from schematics</h2>
...
In such cases you may want to combine multiple schematics.</p><h3 id="run-local-schematics-using-the-runschematictask-1">Run local schematics using the <code>RunSchematicTask</code></h3>
...
<h3 id="run-schematics-by-using-the-schematic-and-externalschematic-function-1">Run schematics by using the <code>schematic()</code> and <code>externalSchematic()</code> function</h3>
