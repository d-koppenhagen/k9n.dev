...
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#B392F0">ng</span><span style="color:#9ECBFF"> add</span><span style="color:#9ECBFF"> ngx-semantic-version</span></span></code></pre>
...
<pre><code>* 65f597a (HEAD -> master) adjust readme
...
* 1e34db6 initial commit</code></pre><p>When you see such a history you know almost nothing: neither what features have been integrated nor if there was a bugfix or a breaking change. There is almost no meaningful context.</p>
...
[optional footer]</code></pre><p>Let&#39;s see what is the meaning of these parameters:</p>
<ul>
...
<pre><code>refactor(footer): move footer widget into separate module

BREAKING CHANGES
The footer widget needs to be imported from \`widgets/FootWidgetModule\` instead of \`common\` now.

closes #45</code></pre><p>Following this pattern allows us to extract valuable information from the git history later.
...
<p><img src="images/blog/commitlint.svg" alt="commitlint cli"></p>
...
<p><img src="images/blog/commitizen.svg" alt="commitizen cli"></p>
...
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#6A737D">// package.json</span></span>
<span class="line"><span style="color:#E1E4E8">...</span></span>
...
<p><img src="images/blog/commitizen-vscode.gif" alt="commitizen vscode plugin"></p>
...
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#B392F0">npm</span><span style="color:#9ECBFF"> run</span><span style="color:#9ECBFF"> release</span></span></code></pre>
