...
}`]});let f=c;const E=n=>["/",n],I=(n,e)=>e.slug;function j(n,e){if(n&1&&C(0,"dk-card",2),n&2){const t=e.$implicit;s("post",t)}}function R(n,e){if(n&1&&L(0,j,1,1,"dk-card",2,I),n&2){const t=u();T(t.reducedPostList)}}function U(n,e){n&1&&h(0," Es wurden keine passenden Einträge gefunden. ")}function D(n,e){if(n&1&&(m(0,"ul",1)(1,"li")(2,"a",3),h(3),d()()()),n&2){const t=u();o(2),s("routerLink",F(2,E,t.content())),o(),g("Alle anzeigen (",t.postsFiltered.length,")")}}const l=class l{constructor(){this.content=r.required(),this.posts=r.required(),this.keyword=r(""),this.search=r(""),this.max=r(),this.postsFiltered=[],this.reducedPostList=[]}updatePosts(){this.postsFiltered=(this.posts()||[]).filter(e=>{const t=this.content();return t?e.filename.includes(`/${t}/`):!0}).filter(e=>e.attributes.published!==!1).filter(e=>{const t=this.keyword();return t?!!e.attributes.keywords?.includes(t):!0}).filter(e=>{const t=this.search().toLowerCase();return t?e.attributes.keywords?.includes(this.search())||e.attributes.title.toLowerCase().includes(t)||e.attributes.description.toLowerCase().includes(t)||e.attributes.author.name.toLowerCase().includes(t)||e.attributes.author.mail.toLowerCase().includes(t):!0}).sort((e,t)=>{const i=+new Date(e.attributes.created),a=+new Date(t.attributes.created);return i-a}).reverse(),this.reducedPostList=this.postsFiltered.slice(0,this.max())}ngOnInit(){this.updatePosts()}ngOnChanges(){this.updatePosts()}};l.ɵfac=function(t){return new(t||l)},l.ɵcmp=x({type:l,selectors:[["dk-preview"]],inputs:{content:[1,"content"],posts:[1,"posts"],keyword:[1,"keyword"],search:[1,"search"],max:[1,"max"]},features:[v],decls:4,vars:2,consts:[[1,"features"],[1,"actions"],[3,"post"],[1,"button",3,"routerLink"]],template:function(t,i){if(t&1&&(m(0,"section",0),p(1,R,2,0)(2,U,1,0),d(),p(3,D,4,4,"ul",1)),t&2){o(),_(i.reducedPostList.length?1:2);const a=i.max();o(2),_(a&&a<i.postsFiltered.length||i.keyword()||i.search()?3:-1)}},dependencies:[w,f],styles:[`.features[_ngcontent-%COMP%] {
  display: grid;
