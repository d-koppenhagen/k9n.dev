...
Also, I will show you a list of extensions and their purpose that will help me and probably you too being more productive.</p><h2 id="introduction-3">Introduction</h2>
...
But most of the tools and software listed here is available for Windows, macOS and Linux distributions.</p><h2 id="software-1">Software</h2>
<p>Let&#39;s get started with some basic software that I use.</p><h3 id="iterm2-1"><a href="https://iterm2.com">iTerm2</a></h3>
...
You can create tabs, use profiles and customize styles and layouts.</p><p><img src="images/blog/dev-setup/iterm2.png" alt="Screenshot: iTerm2"></p><h3 id="cakebrew--macos-only-1"><a href="https://www.cakebrew.com">Cakebrew</a> – macOS only</h3>
...
This lets me easily update and manage my installed Homebrew packages.</p><p><img src="images/blog/dev-setup/cakebrew.png" alt="Screenshot: CakeBrew"></p><h3 id="nvm-1"><a href="https://github.com/nvm-sh/nvm">NVM</a></h3>
...
My recommendation is also to check-in the <code>.nvmrc</code> file in every project to help other team members to use the right version of Node.js automatically.</p><h3 id="fork-1"><a href="https://git-fork.com">Fork</a></h3>
...
<p><strong>Fork</strong> is a very nice, clean and powerful Git GUI that helps you to control Git in an easy and interactive way.</p><p><img src="images/blog/dev-setup/fork.png" alt="Screenshot: Fork"></p><h3 id="visual-studio-code-1"><a href="https://code.visualstudio.com">Visual Studio Code</a></h3>
...
Chrome is also very up-to-date in terms of the latest JavaScript features and it has a wide range of extensions you can install that will help you to even be more productive developing web applications.</p><p><img src="images/blog/dev-setup/chrome.png" alt="Screenshot: Google Chrome"></p><p>A list of my favorite extensions for Google Chrome can be found further down in this article.</p><h3 id="insomnia-1"><a href="https://insomnia.rest">Insomnia</a></h3>
...
However, in my opinion the UI of Postman got a bit confusing during the last years by introducing new features.</p><p><img src="images/blog/dev-setup/insomnia.png" alt="Screenshot: Insomnia"></p><h3 id="drawio-1"><a href="https://draw.io">draw.io</a></h3>
...
Draw.io provides a lot of basic icons and vector graphics for network illustrations, UML, diagrams, engineering icons for circuits and much more.</p><p><img src="images/blog/dev-setup/drawio.png" alt="Screenshot: draw.io"></p><h3 id="recordit-1"><a href="https://recordit.co">RecordIt</a></h3>
...
<strong>RecordIt</strong> lets you record your screen and create small screencasts that can be shared via a simple URL as a video or GIF.</p><p><img src="images/blog/dev-setup/recordit.png" alt="Screenshot: RecordIt"></p><h3 id="keycastr-1"><a href="https://github.com/keycastr/keycastr">KeyCastr</a></h3>
...
For that purpose I use the tool <strong>KeyCastr</strong>.</p><p><img src="images/blog/dev-setup/keycastr.png" alt="Screenshot: KeyCastr"></p><h2 id="visual-studio-code-extensions-1">Visual Studio Code Extensions</h2>
...
<h3 id="htmlhandlebarscsssassscssless-1">HTML/Handlebars/CSS/SASS/SCSS/LESS</h3>
<table>
<thead>
<tr>
<th></th>
...
<h2 id="google-chrome-extensions-1">Google Chrome Extensions</h2>
...
<h2 id="scripts-and-other-tools-1">Scripts and other tools</h2>
...
Most of my configurations is also published in my GitHub repository called <a href="https://github.com/d-koppenhagen/.dotfiles"><code>.dotfiles</code></a>.</p><h3 id="exclude-all-node_modules-from-timemachine-backups-macos-only-1">Exclude all <code>node_modules</code> from TimeMachine backups (macOS only)</h3>
