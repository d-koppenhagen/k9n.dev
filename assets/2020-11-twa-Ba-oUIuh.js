...
<pre><code>git clone https://ng-buch.de/bm4-pwa.git</code></pre><p>Die Online-Version der PWA können Sie unter der folgenden URL abrufen:</p>
...
<p><img src="images/blog/twa/play-register.png" alt="Google Play Console: Registrierung"></p>
...
<p><img src="images/blog/twa/play-create.png" alt="Google Play Console: Eine neue Anwendung erzeugen"></p>
...
<p><img src="images/blog/twa/play-after-create.png" alt="Google Play Console: Dashboard - Ersteinrichtung"></p>
<ul>
...
<p><img src="images/blog/twa/play-dashboard-release.png" alt="Google Play Console: Dashboard - App veröffentlichen"></p>
...
<p><img src="images/blog/twa/play-dashboard-open-track.png" alt="Google Play Console: Dashboard - Einen offenen Track anlegen"></p>
...
<p><img src="images/blog/twa/play-beta-sign.png" alt="Google Play Console: Offenes Testrelease erstellen"></p>
...
<p><img src="images/blog/twa/play-signature.png" alt="Google Play Console: Kopieren des App-Signaturschlüssels"></p>
...
<span class="line"><span style="color:#6A737D">  // ...</span></span>
<span class="line"><span style="color:#E1E4E8">}</span></span></code></pre>
<p>Wir überprüfen das Ergebnis am Besten, indem wir einen Produktiv-Build ausführen und einen einfachen Webserver starten:</p>
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#B392F0">ng</span><span style="color:#9ECBFF"> build</span><span style="color:#79B8FF"> --prod</span></span>
...
<p><img src="images/blog/twa/assetlinks-browser.png" alt="Test der Auslieferung der Datei \`assetlinks.json\` im Browser"></p>
...
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#B392F0">mkdir</span><span style="color:#9ECBFF"> monkey4-pwa-twa-wrapper</span></span>
...
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#F97583">?</span><span style="color:#E1E4E8"> Path to the JDK: /Library/Java/JavaVirtualMachines/adoptopenjdk-8.jdk</span></span>
...
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#B392F0">init</span><span style="color:#9ECBFF"> Fetching</span><span style="color:#9ECBFF"> Manifest:</span><span style="color:#9ECBFF">  https://bm4-pwa.angular-buch.com/manifest.json</span></span>
...
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#F97583">?</span><span style="color:#E1E4E8"> Location of the Signing Key: ./android.keystore</span></span>
...
<p><img src="images/blog/twa/twa-bubblewrap.png" alt="Dateistruktur nach Erzeugung der TWA mithilfe der Bubblewrap CLI"></p>
...
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#B392F0">npx</span><span style="color:#9ECBFF"> @bubblewrap/cli</span><span style="color:#9ECBFF"> build</span></span>
...
<p>Wenn wir keinen Fehler erhalten, sollte sich die fertige signierte App im Hauptverzeichnis befinden und <code>app-release-signed.apk</code> heißen.</p>
<p>Vereinzelt kann es dazu kommen, dass wir eine Fehlermeldung wie die folgende erhalten:</p>
<pre><code>UnhandledPromiseRejectionWarning: Error: Error calling the PageSpeed Insights API: Error: Failed to run the PageSpeed Insight report</code></pre><p>In diesem Fall schlägt die Analyse der App fehl, weil beispielsweise die Website gerade nicht erreichbar ist. Wir können den Build erneut aufrufen und das Flag <code>--skipPwaValidation</code> verwenden, um die Überprüfung der PWA zu überspringen.</p>
<pre class="shiki github-dark" style="background-color:#24292e;color:#e1e4e8" tabindex="0"><code><span class="line"><span style="color:#B392F0">npx</span><span style="color:#9ECBFF"> @bubblewrap/cli</span><span style="color:#9ECBFF"> build</span><span style="color:#79B8FF"> --skipPwaValidation</span></span>
<span class="line"><span style="color:#F97583">?</span><span style="color:#E1E4E8"> KeyStore password: </span><span style="color:#F97583">********</span></span>
<span class="line"><span style="color:#F97583">?</span><span style="color:#E1E4E8"> Key password: </span><span style="color:#F97583">********</span></span>
<span class="line"><span style="color:#B392F0">build</span><span style="color:#9ECBFF"> Building</span><span style="color:#9ECBFF"> the</span><span style="color:#9ECBFF"> Android-App...</span></span>
<span class="line"><span style="color:#B392F0">build</span><span style="color:#9ECBFF"> Zip</span><span style="color:#9ECBFF"> Aligning...</span></span>
...
<p><img src="images/blog/twa/android-studio-generate-signed-apk.png" alt="Android Studio: Signierte APK erstellen"></p>
<p>Wir wählen hier den Punkt <em>&quot;APK&quot;</em> aus und klicken auf <em>&quot;Next&quot;</em>.</p>
<p><img src="images/blog/twa/android-studio-generate-signed-apk2.png" alt="Android Studio: Signierte APK erstellen"></p>
...
<p><img src="images/blog/twa/android-studio-generate-signed-apk3.png" alt="Android Studio: Signierte APK erstellen"></p>
...
<p><img src="images/blog/twa/play-beta-release.png" alt="Google Play Console: Das Beta-Release veröffentlichen"></p>
...
<p><img src="images/blog/twa/play-release-overview.png" alt="Google Play Console: Übersicht mit Veröffentlichungsstatus"></p>
