import{j as b,ag as x,ah as f,ɵ as C,w as _,ai as w,x as m,aj as M,ak as j,al as k,a as o,b as l,d as c,e as g,G as h,I as s,y as i,W as P,ad as u}from"./index-nZOzKHyg.js";import{M as v}from"./meta.service-Dh6hi_P0.js";function y(a,t){if(a&1&&g(0,"img",3),a&2){const n=h();s("src",n.attributes.thumbnail.header,u)}}function O(a,t){if(a&1&&(o(0,"article",0)(1,"div",1)(2,"h1"),l(3),c(),o(4,"section",2),_(5,y,1,1,"img",3),c(),o(6,"section",4),g(7,"analog-markdown",5),o(8,"div",6)(9,"a",7),l(10," Auf GitHub bearbeiten "),c()()()()()),a&2){const n=t,r=h();s("lang",n.attributes.language),i(3),P(n.attributes.title),i(2),m(n.attributes.thumbnail&&n.attributes.thumbnail.header?5:-1),i(2),s("lang",n.attributes.language||"de")("content",n.content),i(2),s("href",r.editOnGithubLink(n.filename),u)}}const e=class e{constructor(){this.metaService=b(v),this.post$=x({param:"slug",subdirectory:"projects"}).pipe(f(t=>this.metaService.createMetaDataForPost("projects",t)))}editOnGithubLink(t){return`https://github.com/d-koppenhagen/k9n.dev/edit/main${t}.md`}};e.ɵfac=function(n){return new(n||e)},e.ɵcmp=C({type:e,selectors:[["ng-component"]],decls:2,vars:3,consts:[[1,"wrapper","alt",3,"lang"],[1,"inner"],[1,"project-header"],["alt","",3,"src"],[1,"project-content"],["classes","markdown-content",3,"lang","content"],[1,"edit-on-github"],["rel","noopener noreferrer",3,"href"]],template:function(n,r){if(n&1&&(_(0,O,11,6,"article",0),w(1,"async")),n&2){let p;m((p=M(1,1,r.post$))?0:-1,p)}},dependencies:[j,k],styles:[`.wrapper[_ngcontent-%COMP%] {
  margin-top: 0;
}
